namespace TheAsocialNetwork.UI.UWP
{
    ...
    using TheAsocialNetwork.UI.UWP.Controls;
    ...
    public sealed partial class AppShell : Page
    {
        ...
        public AppShell()
        {
            ...
            SystemNavigationManager.GetForCurrentView().BackRequested += this.SystemNavigationManager_BackRequested;
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            ((Page)sender).Loaded -= this.Page_Loaded;
            this.CheckTogglePaneButtonSizeChanged();
        }
